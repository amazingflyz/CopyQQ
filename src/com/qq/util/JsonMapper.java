/**   
 * @Company: 浙江维尔科技股份有限公司 
 * @Department: 驾校产品事业部 
 * @Description: 驾校智能管理平台 
 * @Address: 杭州市滨江区六和路368号海创基地北4楼B3区     
 */
package com.qq.util;
...
public class JsonMapper {
	 ...
	 * 如果JSON字符串为"[]", 返回空集合. 如需反序列化复杂Collection如List<MyBean>,请使用fromJson(String,JavaType)
	...
	/**
	 * 设定是否使用Enum的toString函数來读写Enum, 为False時使用Enum的name()函数來读写Enum, 默认为False.
